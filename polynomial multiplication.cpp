...
NODE* create_polynomial()
{
	...
	for(int i=1;i<=n;i++)
	{
		float co;
		int ex;
		printf("Enter the coeff for term %d: ",i);
		scanf("%f",&co);
		printf("Enter the exponential  of term %d: ",i);
		scanf("%d",&ex);
...
{
	printf("Polynomial1:\n");
	NODE *poly1=create_polynomial();  //create a polynomial1
	printf("Polynomial2:\n");
	NODE *poly2=create_polynomial();  //create a polynomial2
